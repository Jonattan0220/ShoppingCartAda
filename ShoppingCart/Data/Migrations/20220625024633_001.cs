    ...
    public partial class _001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductItemBrandId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductItemBrands", x => x.ProductItemBrandId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAddressProvinces", x => x.UserAddressProvinceId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAddressCities", x => x.UserAddressCityId);
                    table.ForeignKey(
                        name: "FK_UserAddressCities_UserAddressProvinces_UserAddressProvinceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductItems_ProductItemBrands_ProductItemBrandId",
                        column: x => x.ProductItemBrandId,
                        principalTable: "ProductItemBrands",
                        principalColumn: "ProductItemBrandId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_IdentificationTypes_IdentificationTypeId",
                        column: x => x.IdentificationTypeId,
                        principalTable: "IdentificationTypes",
                        principalColumn: "IdentificationTypeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_UserAddressCities_UserAddressCityId",
                        column: x => x.UserAddressCityId,
                        principalTable: "UserAddressCities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_IdentificationTypeId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItems_ProductItemBrandId",
                table: "ProductItems",
                column: "ProductItemBrandId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAddressCities_UserAddressProvinceId",
                table: "UserAddressCities",
